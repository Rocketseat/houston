...
export const answerFromSingleTranscriptionPrompt = new PromptTemplate({
  ...
  template: `
    ...
    Abaixo você também encontrará a transcrição da aula atual que você deve usar para responder a pergunta do usuário.
